...
public class XMLReader {
	...
	public static void main(String[] args) {
		...
		// Calculates the cost of each book
		CalculateCost(cat,0.80);
	...
	private static Catalog CalculateCost(Catalog cat, double CalculateCost) {
		for (Book b : cat.getBooks()) {
			double newCost = (b.getPrice() * 0.8);
